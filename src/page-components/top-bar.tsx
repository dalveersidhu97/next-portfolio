        ...
        <>
            ...
            <div className="flex justify-between shadow-md lg:hidden bg-primary dark:bg-primaryLight2 text-foregroundLight dark:text-foregroundDark">
                ...
                <div className="flex items-center ml-auto">
                    {colorScheme==='dark' && <div role="button" onClick={() => setColorScheme('auto')} className={`dark:hover:text-grayDark hover:bg-primaryLight p-2 rounded-md flex items-center gap-2`}>
                    ...
                    {(colorScheme==='auto' || !colorScheme) && <div role="button" onClick={() => setColorScheme('light')} className={`dark:hover:text-grayDark text-foregroundLight dark:text-foregroundDark hover:text-primary hover:bg-primaryLight p-2 rounded-md flex items-center gap-2`}>
